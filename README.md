# 🔥 LAOCOONTE: VAE-Based Anomaly Detection in IIoT Networks 🔥

Este proyecto implementa un **Autoencoder Variacional (VAE)** para la detección de anomalías en redes **IIoT (Industrial IoT)**. Utiliza tráfico de red preprocesado para entrenar un modelo que diferencia entre tráfico normal y anómalo.
...
📧 **Contacto:** [LinkedIn](https://www.linkedin.com/in/jaimealonsoruiz/)  
🔗 **Repositorios:** [GitHub](https://github.com/jaimealruiz/)
